...
import { Button, Alert, Loading } from '@chips/components';
...
<template>
  <div class="theme-panel">
    ...
    <Alert
      ...
      type="warning"
      :message="t('card_settings.theme_hint')"
      show-icon
      class="theme-panel__hint"
    >
      <template #icon>
        <span class="theme-panel__hint-icon">💡</span>
      </template>
    </Alert>
  </div>
</template>
...
/* 提示信息 */
.theme-panel__hint :deep(.chips-alert) {
  padding: var(--chips-spacing-md, 16px);
...
.theme-panel__hint :deep(.chips-alert__message) {
  font-size: 13px;
  color: var(--chips-color-text-secondary, #6b7280);
  line-height: 1.5;
}
