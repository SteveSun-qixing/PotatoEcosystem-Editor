        ...
        <div class="card-settings-dialog">
          ...
          <div class="card-settings-dialog__body">
            ...
            >
              ...
              <TabPane key="cover" name="cover" :tab="t('card_settings.tab_cover')">
                <div class="card-settings-dialog__panel">
                  <CoverPanel @open-cover-maker="openCoverMaker" />
                </div>
              </TabPane>

              <TabPane key="theme" name="theme" :tab="t('card_settings.tab_theme')">
                <div class="card-settings-dialog__panel">
                  <ThemePanel v-model="selectedTheme" />
                </div>
              </TabPane>

              <TabPane key="export" name="export" :tab="t('card_settings.tab_export')">
                <div class="card-settings-dialog__panel">
                  <ExportPanel
                    :card-id="cardId"
                    :card-info="cardInfo"
